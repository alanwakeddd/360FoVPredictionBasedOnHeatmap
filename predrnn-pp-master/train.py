...
tf.app.flags.DEFINE_string('train_data_paths',
                        r'C:\Users\hans\Dropbox\predrnn-pp-master\data_provider\shanghai_train.npz',
                           'train data paths.')
tf.app.flags.DEFINE_string('valid_data_paths',
                        r'C:\Users\hans\Dropbox\predrnn-pp-master\data_provider\shanghai_test.npz',
...
tf.app.flags.DEFINE_integer('img_width', 36,
                            'input image width.')
...
def main(argv=None):
    ...
    print(type(train_input_handle))
    # print(train_input_handle.shape)
